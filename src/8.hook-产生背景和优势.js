...
// 2、Hooks解决了什么问题
// Hooks的出现解决了俩个问题 1组件的状态逻辑复用 2class组件自身的问题
//    1 组件的状态逻辑复用
//    在hooks出现之前，react先后尝试了mixins混入，HOC高阶组件，render - props等模式
//    但是都有各自的问题，比如mixin的数据来源不清晰，高阶组件的嵌套问题等等
//    2、class组件自身的问题
//    class组件就像一个厚重的战舰一样，大而全，提供了很多东西，有不可忽视的学习成本，比如
//    各种生命周期，this指向问题等等，而我们更多时候需要的是一个轻快灵活的快艇
